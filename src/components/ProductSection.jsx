  ...
  return (
    <section className="py-12 px-4 bg-gray-50">
      ...
      <div className="flex justify-center mt-12">
        <Link to={'/products'} className="bg-white border-[1px] border-indigo-600 text-indigo-600 font-semibold px-8 py-3 rounded-full shadow-md hover:bg-indigo-50 transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-300">
          View All Products
        </Link>
      </div>
    </section>
