  ...
  const features = [
    {
      ...
      cardColor: 'from-pink-50 to-red-50',
      },
    {
      icon: '👥',
    ...
    },
    {
      ...
      cardColor: 'from-green-50 to-cyan-50',
    },
  ];
  ...
  return (
    <section className="py-12 px-4">
      <div className="max-w-7xl mx-auto text-center">
        {/* Heading */}
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-slate-800">Key Features</h2>
        <p className='text-gray-500'>Explore the core functionalities that make our platform stand out.</p>
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-slate-800">Empowering Your Business with Innovative Solutions</h2>
